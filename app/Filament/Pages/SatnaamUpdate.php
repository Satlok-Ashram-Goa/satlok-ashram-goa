...
class SatnaamUpdate extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.pages.satnaam-update';
    
    protected static ?string $navigationGroup = 'Bhagat Database';
    
    protected static ?int $navigationSort = 3;
    
    protected static ?string $navigationLabel = 'Satnaam Update';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('satnaam_mantra_date')
                    ->label('Satnaam Date')
                    ->date('d/m/Y')
                    ->placeholder('Not set'),
            ])
            ->actions([
                TableAction::make('edit')
                    ...
                    ->url(fn (Bhagat $record): string => route('filament.admin.pages.edit-satnaam', ['record' => $record->id]))
            ])
